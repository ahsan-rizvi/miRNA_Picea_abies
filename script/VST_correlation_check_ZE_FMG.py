...
for i in range(0,len(miRNA_pair)):
    ...
    miRNA_VST=[float(miRNA_temp2[9]),float(miRNA_temp2[11]),float(miRNA_temp2[13]),float(miRNA_temp2[15]),float(miRNA_temp2[17]),float(miRNA_temp2[19]), float(miRNA_temp2[22]),float(miRNA_temp2[24]),float(miRNA_temp2[-1]),float(miRNA_temp2[26]),float(miRNA_temp2[28]),float(miRNA_temp2[-7]),  float(miRNA_temp2[31]),float(miRNA_temp2[33]),float(miRNA_temp2[35]),float(miRNA_temp2[37]),float(miRNA_temp2[39]),float(miRNA_temp2[-14]), float(miRNA_temp2[-11]),float(miRNA_temp2[-8]),float(miRNA_temp2[-3]),float(miRNA_temp2[-2])]

    #print('##########################')
    mRNA_temp=mRNAid_in_Target_matched.split('\n')     
    mRNA_temp2=mRNA_temp[0].split('\t')

    mRNA_VST=[float(mRNA_temp2[9]),float(mRNA_temp2[11]),float(mRNA_temp2[13]),float(mRNA_temp2[15]),float(mRNA_temp2[17]),float(mRNA_temp2[19]), float(mRNA_temp2[22]),float(mRNA_temp2[24]),float(mRNA_temp2[-1]),float(mRNA_temp2[26]),float(mRNA_temp2[28]),float(mRNA_temp2[-7]),  float(mRNA_temp2[31]),float(mRNA_temp2[33]),float(mRNA_temp2[35]),float(mRNA_temp2[37]),float(mRNA_temp2[39]),float(mRNA_temp2[-14]), float(mRNA_temp2[-11]),float(mRNA_temp2[-8]),float(mRNA_temp2[-3]),float(mRNA_temp2[-2])]
    #-------------------------------------------------
